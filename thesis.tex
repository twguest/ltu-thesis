...
\newcommand{\mathcal{D}}{\ensuremath{\D}} 
\newcommand{\mathcal{DF}}{\ensuremath{^{(F)}\D}} 
\newcommand{\mathcal{DFr}}{\ensuremath{^{(Fr)}\D}} 
\newcommand{\mathcal{DH}}{\ensuremath{^{(HF)}\D}} 
%%% curl
...
\begin{document}
  ...
  \chapter{Computational Modelling}\label{c:Background}
  \input{text/ch2}
